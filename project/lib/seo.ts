...
export const seoConfigs = {
  ...
  blog: {
    ...
    description: 'Leia artigos sobre produtos, dicas de compras, notícias sobre tecnologia, moda, esportes e muito mais no blog da VITRINE.',
    keywords: [
      'blog',
      'artigos',
      'dicas',
...
export function generateSellerSEO(seller: any) {
  return generateMetadata({
    ...
    description: `Conheça ${seller.businessName} na VITRINE. Produtos de qualidade e confiança.`,
    keywords: [
      seller.businessName,
      'vendedor',
      'produtos',
