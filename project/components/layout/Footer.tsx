          ...
          <div className="flex flex-col lg:flex-row justify-between items-center space-y-4 lg:space-y-0">
            ...
            <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                {/*
                <Link href="#" className="p-2 bg-gray-8 rounded-full hover:bg-primary transition-colors" aria-label="Instagram">
                  <Instagram size={16} />
                </Link>
                ...
                */}
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-3 py-1.5 bg-gray-8 rounded-full hover:bg-primary transition-colors text-xs font-medium"
                  aria-label="WhatsApp"
                >
                  WhatsApp
                </a>
