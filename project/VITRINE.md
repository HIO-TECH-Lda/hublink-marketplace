...
**Arquivo:** `contexts/MarketplaceContext.tsx`
...
### **Outros**
37. **`app/not-found.tsx`** - Página 404 atualizada
38. **`public/offline.html`** - Página offline atualizada

**Total de arquivos alterados: 38+ arquivos**
...
grep -r "Txova\|txova" . --include="*.ts" --include="*.tsx" --include="*.js" --include="*.jsx" --include="*.json"
