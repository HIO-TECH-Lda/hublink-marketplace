      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xl font-bold text-gray-9">{stats?.total.toLocaleString() || 0}</p>
              </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xl font-bold text-green-600">{stats?.active.toLocaleString() || 0}</p>
              </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xl font-bold text-red-600">{stats?.rejected.toLocaleString() || 0}</p>
              </div>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs text-gray-6 mb-1">Avaliação Média</p>
