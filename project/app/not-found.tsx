           ...
           <div className="bg-white rounded-lg shadow-sm p-6 max-w-4xl mx-auto">
             ...
             <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              >
                ...
                <p className="text-sm text-gray-6">Descubra nossa seleção de produtos de qualidade</p>
              </Link>
              ...
              >
                ...
                <p className="text-sm text-gray-6">Dicas e tendências sobre produtos e compras</p>
              </Link>
